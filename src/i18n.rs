...
https://yoomoney.ru/to/410011348629282",
    ...
    msg_builtin_muted: "Built-in effects are muted while My effects is selected.",
    msg_custom_muted: "Custom effects are muted while Built-in effects is selected.",
...
https://yoomoney.ru/to/410011348629282",
    ...
    msg_builtin_muted: "Встроенные эффекты заглушены, пока выбраны Мои эффекты.",
    msg_custom_muted: "Пользовательские эффекты заглушены, пока выбраны Встроенные эффекты.",
